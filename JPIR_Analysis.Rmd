...
#Reverse Scores for select columnn
columnsToReverse <-  c('V91',	'S16',	'X218',	'V189',	'V43',	'V211',	'X228',	'S22',	'X272',	'E141', 'P346',	'V49',	'X250',	'V183',	'X157',	'X265',	'X176',	'H587',	'Q45',	'E134',	'E7',	'X239',	'V187',	'D93',	'E71',	'X178',	'X109',  'H704',  'V282', 'H931',	'E100',	'V128',	'H627',	'V332',	'R24',	'H1144',	'X269',	'X254',	'X173',	'E166',	'H317',	'D100',	'X103',	'V6',	'X118',	'H312',	'H897',	'V103',	'Q108',	'E83',	'H701',	'Q143',	'P431',	'Q30',	'X28',	'H1042',	'H369',	'Q218',	'S26',	'E144', 'N23')
...
dfIPIP3 <- dfIPIP2 %>% group_by(ID) %>%  
     mutate("Anxiety" = (sum(H926,	X269, H927, H754, H761, E92, X265,	H755 ) / 40) , #H758, E141      
            ...
            "Empath" = (sum(D93,	E174,	D19,	X253,	H173,	E144,	D6) / 40) , #,	E166,	V128,	H701,	Q256
